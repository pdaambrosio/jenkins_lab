...
USER jenkins
RUN echo 2.375.1-lts-jdk11 > /usr/share/jenkins/ref/jenkins.install.UpgradeWizard.state
RUN echo 2.375.1-lts-jdk11 > /usr/share/jenkins/ref/jenkins.install.InstallUtil.lastExecVersion
